<template>
    <div id="mobile-menu" class="d-md-none">
        ...
        <div class="navbar bg-dark trim-top fixed-bottom w-100 p-3 justify-content-between bottom-0">
            <material-icon class="material-icon" name="menu" v-on:click="click()" v-show="!offcanvasShow" />
            <material-icon class="material-icon" name="close" v-on:click="click()" v-show="offcanvasShow" />
